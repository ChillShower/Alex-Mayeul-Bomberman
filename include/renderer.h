...
int playerShowUI(player_t* player, window_t* window,SDL_Texture** texturesList, TTF_Font* font);
int draw_player(player_t* player, window_t* window, TTF_Font* police);
int showButton(window_t* window, screen_t* screen,SDL_Texture** texturesList, SDL_Rect* button, TTF_Font* font, char* text, SDL_Color color);
